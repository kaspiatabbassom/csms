...
<div class="container">
  ...
  ?>
    <div class="alert alert-success alert-dismissible fade show" role="alert">
      <strong>Repair product is successfully added!</strong>
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
  <?php
  }
  ...
  <h4 class="m-2 normal-text">Repaired Product <a class="logout-button" style="width:20% ;text-decoration: none;" href="AddRepairProduct.php"><i class="fa-solid fa-plus"></i> Add Product</a></h4>

  <?php
  $sql = "SELECT * from csms_services JOIN csms_users ON csms_services.cid=csms_users.id JOIN csms_product ON csms_services.pid=csms_product.id where repaired='1';";
        ...
        <tbody>
          ...
          <tr class="table-data">
           ...
           <td>
            ...
            <td><?php echo $arrayData['repair_price']?></td>
            <td><?php echo $arrayData['repair_date']?></td>
          </tr>
